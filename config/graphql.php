...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                \App\GraphQL\Queries\Album\AlbumsQuery::class,
                \App\GraphQL\Queries\Album\AlbumQuery::class,
                \App\GraphQL\Queries\Music\MusicsQuery::class,
                \App\GraphQL\Queries\Music\MusicQuery::class,
                \App\GraphQL\Queries\Lyric\LyricsQuery::class,
                \App\GraphQL\Queries\Lyric\LyricQuery::class
            ],
            'mutation' => [
                \App\GraphQL\Mutations\Album\Create::class,
                \App\GraphQL\Mutations\Album\Update::class,
                \App\GraphQL\Mutations\Album\Delete::class,
                \App\GraphQL\Mutations\Music\Create::class,
                \App\GraphQL\Mutations\Music\Update::class,
                \App\GraphQL\Mutations\Music\Delete::class,
                \App\GraphQL\Mutations\Lyric\Create::class,
                \App\GraphQL\Mutations\Lyric\Update::class,
                \App\GraphQL\Mutations\Lyric\Delete::class
            ],
            // The types only available in this schema
            'types' => [
                \App\GraphQL\Types\AlbumType::class,
                \App\GraphQL\Types\MusicType::class,
                \App\GraphQL\Types\LyricType::class
            ],
